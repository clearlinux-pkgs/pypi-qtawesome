...
Source0  : https://files.pythonhosted.org/packages/56/57/2f6c402b4cd91a58fd378a5f36be6b5855cf43dc25f77f581e2612e6d558/qtawesome-1.4.0.tar.gz
...
%prep
%setup -q -n qtawesome-1.4.0
cd %{_builddir}/qtawesome-1.4.0
pushd ..
cp -a qtawesome-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740758590
...
%defattr(-,root,root,-)
/usr/bin/qta-browser
/usr/bin/qta-install-fonts-all-users
